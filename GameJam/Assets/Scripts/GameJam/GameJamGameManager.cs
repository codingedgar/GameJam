...
public class GameJamGameManager : NetworkBehaviour
{
    ...
    public void RemoveTank(GameObject tank)
    {
        ...
        //foreach (var tmp in mCharacters)
        //{
    ...
    private bool OneTankLeft()
    {
        ...
        //    if (mCharacters[i].m_TankRenderers.activeSelf)
        //        numTanksLeft++;
        //}
    ...
    private TankManager GetGameWinner()
    {
        ...
        //for (int i = 0; i < mCharacters.Count; i++)
        //{
        //    if(mCharacters[i].m_Wins > maxScore)
        //    {
        //        maxScore = mCharacters[i].m_Wins;
        //    }

        //    // ... and if one of them has enough rounds to win the game, return it.
        //    if (mCharacters[i].m_Wins == m_NumRoundsToWin)
        //        return mCharacters[i];
        //}
        ...
        //for (int i = 0; i < mCharacters.Count && maxScore > 0; i++)
        //{
        //    mCharacters[i].SetLeader(maxScore == mCharacters[i].m_Wins);
        //}
    ...
    private string EndMessage(int waitTime)
    {
        ...
        //for (int i = 0; i < mCharacters.Count; i++)
        //{
        //    message += "<color=#" + ColorUtility.ToHtmlStringRGB(mCharacters[i].m_PlayerColor) + ">" + mCharacters[i].m_PlayerName + "</color>: " + mCharacters[i].m_Wins + " WINS " 
        //        + (mCharacters[i].IsReady()? "<size=15>READY</size>" : "") + " \n";
        //}
